    ...
    <div id="captcha_msg">
        ...
        <div class="DownloadRepair-captchaComplete">
            ...
            <p id="captcha_complete_alt" style="display: none;">
                If your download does not start, <a href="/file/12coirz96f8ks02/ProjektPassion-0.14-pc-compressed.7z/file" id="captcha_complete_link">click here</a>.
            </p>
        </div>
    </div>
</div>
...
</script><form id="recaptchaForm" action="/file/12coirz96f8ks02/ProjektPassion-0.14-pc-compressed.7z/file" method="post" style="display: none;">
...
<script>
    ...
    mfRecaptchaBus.addEventListener('solved', function(data) {
        ...
        // New page
        let downloadPageSolved = '/file/12coirz96f8ks02/ProjektPassion-0.14-pc-compressed.7z/file?g-recaptcha-response=' + encodeURIComponent(data.detail.token);
        let downloadPageNotLoading = '/file/12coirz96f8ks02/ProjektPassion-0.14-pc-compressed.7z/file?captcha-failure=1';
...
<script type="text/javascript">
 ...
 <script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'9f38a4ac6c2ac5ad',t:'MTc3NzQwNjMyMg=='};var a=document.createElement('script');a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body> </html>