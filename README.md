...
# 📥 Download Files1 1via Commit Message

A GitHub Actions workflow1 that lets you download files into your repository just by writing a special commit message — no terminal or command line needed.
.......
---
